// Machine generated by peg-sharp 1.0.0.0 from Parser.peg.
...
internal sealed partial class Parser
{
	public Parser()
	{
		...
		m_ParseMethod26 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.AttrValue);};
		m_ParseMethod27 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseLiteral(s, null, "}");};
		m_ParseMethod28 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.KeyValue);};
		m_ParseMethod29 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.KeyNoValue);};
		m_ParseMethod30 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.Id);};
		m_ParseMethod31 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseLiteral(s, null, ":");};
		m_ParseMethod32 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.Value);};
		m_ParseMethod33 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.NotStrId);};
		m_ParseMethod34 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.Str1);};
		m_ParseMethod35 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.Str2);};
		m_ParseMethod36 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.NotStrVal);};
		m_ParseMethod37 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.Str1);};
		m_ParseMethod38 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.Str2);};
		m_ParseMethod39 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseRange(s, null, true, "'\":}", string.Empty, null, "[^'\":}]");};
		m_ParseMethod40 = (ParseMethod)delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 2147483647,
				m_ParseMethod41);};
		m_ParseMethod41 = (ParseMethod)delegate (State s2, List<Result> r2) {return DoParseRange(s2, null, true, ":}", string.Empty, null, "[^:}]");};
		m_ParseMethod42 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseRange(s, null, true, "'\":}", string.Empty, null, "[^'\":}]");};
		m_ParseMethod43 = (ParseMethod)delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 2147483647,
				m_ParseMethod44);};
		m_ParseMethod44 = (ParseMethod)delegate (State s2, List<Result> r2) {return DoParseRange(s2, null, true, "}", string.Empty, null, "[^}]");};
		m_ParseMethod45 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseLiteral(s, null, "\"");};
		m_ParseMethod46 = (ParseMethod)delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 2147483647,
				m_ParseMethod47);};
		m_ParseMethod47 = (ParseMethod)delegate (State s2, List<Result> r2) {return DoParseRange(s2, null, true, "\"", string.Empty, null, "[^\"]");};
		m_ParseMethod48 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseLiteral(s, null, "\"");};
		m_ParseMethod49 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseLiteral(s, null, "'");};
		...
		m_ParseMethod52 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseLiteral(s, null, "'");};
		m_ParseMethod53 = (ParseMethod)delegate (State s, List<Result> r) {return DoParse(s, r, (int)NonTerminalEnum.S);};
		m_ParseMethod54 = (ParseMethod)delegate (State s, List<Result> r) {return DoParseRange(s, null, false, string.Empty, "\x0001\xFFFF", null, ".");};
	...
	private State DoParseAttrRule(State _state, List<Result> _outResults)
	{
		...
		List<Result> results = new List<Result>();
			...
			_state = DoParse(_state, results, (int)NonTerminalEnum.BraceAttr);
