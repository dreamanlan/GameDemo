...
{
    public IntUobjDict() { }
    public IntUobjDict(int capacity) : base(capacity) { }
...
{
    public StrUobjDict() { }
    public StrUobjDict(int capacity) : base(capacity) { }
...
{
    public ObjUobjDict() { }
    public ObjUobjDict(int capacity) : base(capacity) { }
...
{
    public UobjIntDict() { }
    public UobjIntDict(int capacity) : base(capacity) { }
...
{
    public UobjStrDict() { }
    public UobjStrDict(int capacity) : base(capacity) { }
...
{
    public UobjObjDict() { }
    public UobjObjDict(int capacity) : base(capacity) { }
...
{
    public UobjUobjDict() { }
    public UobjUobjDict(int capacity) : base(capacity) { }
