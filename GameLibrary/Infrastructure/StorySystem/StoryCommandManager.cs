...
namespace StorySystem
{
    ...
    public sealed class StoryCommandManager
    {
        ...
        private StoryCommandManager()
        {
            ...
            StoryValueManager.Instance.RegisterValueFactory("story", new StoryValueFactoryHelper<CommonValues.StoryValue>());
            StoryValueManager.Instance.RegisterValueFactory("message", new StoryValueFactoryHelper<CommonValues.MessageValue>());
