...
{
    public sealed class EntityKdTree
    {
        ...
        public sealed class KdTreeData
        {
            ...
            public KdTreeData(EntityInfo obj)
            {
                CopyFrom(obj);
            }
        ...
        public void AddObjForBuild(EntityInfo obj)
        {
            ...
            if (null == m_Objects[m_ObjectNum])
                m_Objects[m_ObjectNum] = new KdTreeData(obj);
            else
        ...
        public void QueryWithAction(EntityInfo obj, float range, MyAction<float, KdTreeData> visitor)
        {
            QueryWithAction(obj.View.position, range, visitor);
        }
        ...
        public void QueryWithFunc(EntityInfo obj, float range, MyFunc<float, KdTreeData, bool> visitor)
        {
        ...
        private bool Visit(MyFunc<float, KdTreeData, bool> visitor, float distSqr, KdTreeData obj)
        {
            try {
        ...
        private bool Visit(MyFunc<float, float, float, float, int, int, KdTreeData[], bool> visitor, float minx, float minz, float maxx, float maxz, int begin, int end, KdTreeData[] objs)
        {
            try {
