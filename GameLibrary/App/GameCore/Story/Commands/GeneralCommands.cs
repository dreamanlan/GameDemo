...
namespace GameLibrary.Story.Commands
{
    ...
    internal class PreloadCommand : AbstractStoryCommand
    {
        ...
        private List<IStoryFunction<string>> m_DslFiles = new List<IStoryFunction<string>>();
    }
    /// <summary>
    /// startstory(story_id);
    /// </summary>
                    ...
                    if (m_Position.HaveValue) {
                        ...
                        if (0 == worldOrLocal) {
                            ...
                            if (null != entityInfo) {
                                ...
                                movementInfo.SetPosition(movementInfo.GetPosition3D() + new UnityEngine.Vector3(v.x, v.y, v.z));
                            }
                            else {
                                obj.transform.position += new UnityEngine.Vector3(v.x, v.y, v.z);
                            }
    ...
    internal class ChangeSceneCommand : AbstractStoryCommand
    {
        ...
        private IStoryFunction<string> m_TargetScene = new StoryFunction<string>();
    }
    /// <summary>
