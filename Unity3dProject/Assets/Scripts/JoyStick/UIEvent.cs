...
public class UIEvent
{
    ...
    public static void BindScroll(GameObject go, UIEvent.DelegateWithEventData fun) {
        GetHandler<EventTriggerScroll>(go).onScroll = fun;
    }
    public static void BindCancel(GameObject go, UIEvent.DelegateWithBaseEventData fun) {
        GetHandler<EventTriggetCancel>(go).onCancel = fun;
    }
    public static void BindDestroy(GameObject go, UIEvent.VoidDelegate fun) {
...
public class EventTriggerScroll : MonoBehaviour, IScrollHandler
{
    public UIEvent.DelegateWithEventData onScroll;
    public void OnScroll(PointerEventData eventData) {
        if (onScroll != null) onScroll(eventData);
    }
}

public class EventTriggetCancel : MonoBehaviour, ICancelHandler
{
    public UIEvent.DelegateWithBaseEventData onCancel;
