script(main)
{
    ...
    onmessage("show_centerinfo")args($id,$info,$interval,$start,$end)
    {
        ...
        storywait(500);
        localmessage("hide_centerinfo",$id);
    };
    onmessage("hide_centerinfo")args($id)
    {
        @window.SetActive(changetype(0,"bool"));
        firemessage("on_hide_centerinfo",$id);
    };
};